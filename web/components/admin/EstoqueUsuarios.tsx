...
export default function EstoqueUsuarios() {
  ...
  return (
    <div>
      ...
      {modalDeletar && estoqueParaDeletar && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-red-800">
                      Tem certeza que deseja deletar o estoque de <strong>"{estoqueParaDeletar.produtoNome}"</strong> do usuário <strong>"{estoqueParaDeletar.usuarioNome}"</strong>?
                    </p>
            ...
            <div className="flex items-center justify-end space-x-3 p-6 border-t border-gray-200">
              ...
              <button
                onClick={confirmarDeletarEstoque}
                disabled={deletando}
