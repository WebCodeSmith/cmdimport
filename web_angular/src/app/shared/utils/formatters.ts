 ...
 * Remove zeros desnecessários à direita, mas mantém o zero quando o valor é 0
 */
export const formatNumber = (valor: number, minDecimals: number = 0, maxDecimals: number = 4): string => {
  // Se o valor for 0, retornar "0" diretamente
  if (valor === 0) {
    return '0'
  }
  ...
  // Remove zeros desnecessários à direita após a vírgula, mas não remove o número inteiro
